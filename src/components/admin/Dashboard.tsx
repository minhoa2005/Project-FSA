...
import { countAccBan, countAccount, countBlogs, get5accNew } from '@/service/admin/dashboard'
import { Ban, KeyRound, Unlock } from 'lucide-react'
import {
    Table,
    TableBody,
    TableCaption,
    ...
    useEffect(() => {
        const fetchCount = async () => {
            try {
                ...
                if (dataCountAcc.success && dataCountBlogs.success && dataCountBan.success && dataAcc.success) {
